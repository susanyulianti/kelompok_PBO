    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card  card-plain">
          ...
          <div class="card-body">
            <form action="{{ route('member.store') }}" method="POST" id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" enctype="multipart/form-data">
                @csrf
                <div class="form-row">
                  <div class="form-group col-md-6">
                    <label for="inputKodeMember">Kode Member</label>
                    <input type="text" name="kd_member" class="form-control" id="inputKodeMember">
                  </div>
                  <div class="form-group col-md-6">
